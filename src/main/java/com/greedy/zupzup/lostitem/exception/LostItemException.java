...
public enum LostItemException implements ExceptionCode {
    ...
    ACCESS_FORBIDDEN_PLEDGED(HttpStatus.CONFLICT, "서약이 진행 중입니다.", "이미 서약 진행 중인 분실물로, 조회가 제한됩니다."),
    ACCESS_FORBIDDEN_FOUND(HttpStatus.CONFLICT, "회수가 완료되었습니다.", "이미 주인이 찾아간 분실물로, 조회가 제한됩니다."),
